...
/// Testing the for of loop , instead of using the map method
const firstAnswer = data[6].answers;
for (const answer of firstAnswer) {
    console.log(`Was born in ${answer.answer}`)
}

const mapTest = data[qNumber].map((item) => item.answer )
console.log(mapTest)
////////////////////
...
questionScreen.textContent = data[0].question;
answerScreen.innerHTML = data[0].answers.map((item, index)=> `<div class = 'answer'>
